...
cat > batch_jobs/create_singlecore_way_sweep_jobs.sh <<'EOF'
#!/bin/bash
set -e
...
chmod +x batch_jobs/create_singlecore_way_sweep_jobs.sh
./batch_jobs/create_singlecore_way_sweep_jobs.sh
